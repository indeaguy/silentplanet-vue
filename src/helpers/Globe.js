...
export class Globe {
  ...
  createSphere() {
    ...
    var sphereMaterial = new THREE.MeshBasicMaterial({ color: parseInt(this.config.FILL_COLOUR, 16), side: THREE.DoubleSide, wireframe: parseInt(this.config.FILL_COLOUR, 16), wireframe: this.config.WIREFRAME, transparent: this.config.TRANSPARENT, opacity: this.config.OPACITY });
